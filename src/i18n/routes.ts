...
export const routeRegistry = {
  ...
  waitTimes: {
    ...
    paths: {
      ...
      en: '/en/wartezeiten/',
      nl: '/nl/wachttijden/',
      es: '/es/tiempos-de-espera/',
      sv: '/sv/vantetider/',
      ro: '/ro/timpi-de-asteptare/',
      cs: '/cs/cekaci-doby/',
      pl: '/pl/czasy-oczekiwania/',
      tr: '/tr/bekleme-sureleri/',
      da: '/da/ventetider/',
      el: '/el/chronoi-anamonis/',
      pt: '/pt/tempos-de-espera/',
      nb: '/nb/ventetider/',
      he: '/he/זמני-המתנה/',
      hu: '/hu/varakozasi-idok/',
    },
  },
  crowdCalendar: {
    indexable: true,
    paths: {
      ...
      nl: '/nl/druktekalender/',
      es: '/es/calendario-de-afluencia/',
      sv: '/sv/besoksprognos/',
      ro: '/ro/calendar-aglomeratie/',
      cs: '/cs/kalendar-navstevnosti/',
      pl: '/pl/kalendarz-frekwencji/',
      tr: '/tr/yogunluk-takvimi/',
      da: '/da/besogsprognose/',
      el: '/el/imerologio-episkepsimotitas/',
      pt: '/pt/calendario-de-lotacao/',
      nb: '/nb/besoksprognose/',
      he: '/he/תחזית-עומס/',
      hu: '/hu/latogatottsagi-naptar/',
    },
  },
  imprint: {
    indexable: true,
    paths: {
      ...
      it: '/it/impressum/',
      en: '/en/impressum/',
      nl: '/nl/juridisch-en-privacy/',
      es: '/es/aviso-legal-y-privacidad/',
      sv: '/sv/juridisk-information-och-integritet/',
      ro: '/ro/informatii-legale-si-confidentialitate/',
      cs: '/cs/pravni-informace-a-soukromi/',
      pl: '/pl/informacje-prawne-i-prywatnosc/',
      tr: '/tr/yasal-bildirim-ve-gizlilik/',
      da: '/da/juridisk-information-og-privatliv/',
      el: '/el/nomikes-plirofories-kai-aporrito/',
      pt: '/pt/aviso-legal-e-privacidade/',
      nb: '/nb/juridisk-informasjon-og-personvern/',
      he: '/he/הודעה-משפטית-ופרטיות/',
...
export function normalizeRoutePath(pathname: string): string {
  const encodedPath = pathname.split(/[?#]/, 1)[0] || '/';
  let pathOnly = encodedPath;
  try {
    pathOnly = decodeURI(encodedPath);
  } catch {
    // Keep malformed external input stable; published registry paths are valid.
  }
